...
@Component({
  selector: 'app-tabla-horario-fertilizantes',
  templateUrl: './tabla-horario-fertilizantes.component.html',
  styleUrls: ['./tabla-horario-fertilizantes.component.scss']
})
export class TablaHorarioFertilizantesComponent implements OnInit, OnDestroy {
  ...
  aplicarFilto(data){
      //console.log('haciendo la peticion',data);
       ...
       let id_destino  = data.id_origen;
       let sem         = data.sem;
      this.horarioFertilizantesService.getBandaHorariasFiltro(id_producto,id_destino,sem).subscribe(resp => {
