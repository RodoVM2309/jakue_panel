...
@Component({
  selector: 'app-add-mapa-oficina',
  templateUrl: './add-mapa-oficina.component.html',
  styleUrls: ['./add-mapa-oficina.component.scss']
})
export class AddMapaOficinaComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AddMapaOficinaComponent>,
