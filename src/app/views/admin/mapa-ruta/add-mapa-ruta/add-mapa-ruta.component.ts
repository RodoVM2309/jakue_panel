...
@Component({
  selector: 'app-add-mapa-ruta',
  templateUrl: './add-mapa-ruta.component.html',
  styleUrls: ['./add-mapa-ruta.component.scss']
})
export class AddMapaRutaComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AddMapaRutaComponent>,
