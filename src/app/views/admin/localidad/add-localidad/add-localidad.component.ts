...
@Component({
  ...
  templateUrl: './add-localidad.component.html',
  styleUrls: ['./add-localidad.component.scss']
})
export class AddLocalidadComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AddLocalidadComponent>,
  ...
  buildItemForm(item, provincia) {
    this.itemForm = this.fb.group({
      id: [item.id || ''],
      descripcion: [item.descripcion || '', Validators.required],
      id_provincia: [provincia],
      codigopostal: [item.codigopostal || '', Validators.required],
