...
@Component({
  selector: 'app-add-estados-chofer',
  templateUrl: './add-estados-chofer.component.html',
  styleUrls: ['./add-estados-chofer.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class AddEstadosChoferComponent implements OnInit {
  itemForm: FormGroup;
  minDate: any;
  maxDate: any;
  estado: any;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AddEstadosChoferComponent>) { }
  ...
  ngOnInit() {
    ...
    this.itemForm = new FormGroup({
      ...
      desdeDate: new FormControl(this.desdeDate, [Validators.required]),
      hastaDate: new FormControl(this.hastaDate, [Validators.required]),
    ...
    if (!this.data.isNew) {
      ...
      this.desdeDate = this.data.payload.desde;
      ...
      this.itemForm.controls['desdeDate'].setValue(this.now);
      this.itemForm.controls['hastaDate'].setValue(date10);
      this.itemForm.controls['estado'].setValue(this.estado);
      this.onChangeEstado(this.estado);
    }
