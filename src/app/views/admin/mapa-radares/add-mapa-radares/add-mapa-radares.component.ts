...
@Component({
  selector: 'app-add-mapa-radares',
  templateUrl: './add-mapa-radares.component.html',
  styleUrls: ['./add-mapa-radares.component.scss']
})
export class AddMapaRadaresComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AddMapaRadaresComponent>,
