...
@Component({
  ...
  templateUrl: './subir-ficheros.component.html',
  styleUrls: ['./subir-ficheros.component.scss']
})
export class SubirFicherosComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<SubirFicherosComponent>,
    ...
    let extencion = event.target.files[0].type.split("/");
     if(extencion[1] === 'pdf'){
       ...
       this.mostrar_img = true;
        ...
        this.msg          = " Extención no valida solo:  PDF";
        this.btn_disabled = true;
        this.error_val    = true;
  ...
  onUpload() {
    ...
    this.http.post(this.globalService.apiHost + 'documento/documento-up?id=' + this.datos.id, fd,{
      reportProgress : true,
      observe:'events'
    })
      .subscribe(event => {
