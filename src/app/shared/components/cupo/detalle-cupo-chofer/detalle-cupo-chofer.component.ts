...
@Component({
  selector: 'app-detalle-cupo-chofer',
  templateUrl: './detalle-cupo-chofer.component.html',
  styleUrls: ['./detalle-cupo-chofer.component.scss'],
  animations: [
...
export class DetalleCupoChoferComponent implements OnInit {
  cupos: DetallesCupos[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DetalleCupoChoferComponent>,
