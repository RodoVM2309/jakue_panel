...
export class DestinosService {
  ...
  getAllDestinos(page,filtro): Observable<any> {
    const options = { params: new HttpParams().set('page', page).set('Search[descripcion]',filtro) };
    return this.http.get(this.globalService.apiHost + 'destino/listado', options)
  ...
  getDestinoPersona(solucion_muvin = false): Observable<any> {
    return this.http.get(this.globalService.apiHost + `destino-persona/my?solucion_muvin=${solucion_muvin}` )
      .map(this.extractData)
      .catch(this.handleError);
  }
  ...
  getPlayasIntermedias(): Observable<any> {
    return this.http.get<any>(this.globalService.apiHost + 'playas-intermedias')
      .map(this.extractData)
      .catch(this.handleError);
  }

  postDestino(data): Observable<any> {
  ...
  updateDestino(data): Observable<any> {
    return this.http.put(this.globalService.apiHost + 'destino/' + data.id, data)
      .map(this.extractData)
      .catch(this.handleError);
  ...
  deleteDestino(data): Observable<any> {
  ...
  getZonasDestinoSelect(): Observable<any> {
  ...
  existeCodigoPlantaOncca(codigo: any): Observable<any> {
    ...
    return this.http.get(this.globalService.apiHost + 'destino/existe', options)
      .map(this.extractData)
      .catch(this.handleError);
  }
  ...
  // getDatosPlayaIntermedia(id:number):Observable<any> {
  //   var params = new HttpParams();
  //   params = params.set('fecha',filtro.fecha)
  //   let data= {
  //     fecha: filtro.fecha
